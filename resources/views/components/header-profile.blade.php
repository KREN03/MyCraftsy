            ...
            <div class="name d-flex align-items-center">
                ...
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton2"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" id="button-profile"
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="dropdownMenuButton2">
                        <li><a class="dropdown-item" href="{{ route('update_profile') }}">Ubah Profile</a></li>
                        <li><a class="dropdown-item" href="#">Transaksi</a></li>
                        <li><a class="dropdown-item" href="{{ route('stats_profile') }}">Statistik</a></li>
                    </ul>
                </div>
            </div>
