...
@section('content')
    <div class="home container">
        <div class="row py-4 mb-5">
            <div class="col-12 col-md-6 position-relative" id="image-video-like">
                <div class="image-and-video rounded border overflow-hidden">
                    @if ($data->type == 'video')
                    ...
                    @endif
                    <div class="position-absolute w-100 h-100 top-0 left-0 big-like">
                        <svg xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg"
                            height="24" width="24" version="1.1" xmlns:cc="http://creativecommons.org/ns#"
                            xmlns:dc="http://purl.org/dc/elements/1.1/" class="icon-likes">
                    ...
                    <div class="position-absolute d-flex p-3 info-work">
            ...
            <div class="col-12 col-md-6 detail-karya">
                ...
                @if ($data->is_sell)
                    <a href="{{ route('transaksi_informasi') }}">
