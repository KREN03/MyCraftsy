...
@section('content')
    <div class="home container">
        <form action="{{ route('edit_karya', $data->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="d-flex justify-content-center py-3">
                <div class="col-12 col-md-9 p-0">
                    <div class="input-image-video rounded">
                        <img src="{{ Storage::url('karya/' . $data->file) }}" alt="" srcset="" id="image-input"
                            class="image-input">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" class="form-control font-14" id="input_judul" placeholder="" name="title" value="{{ $data->title }}">
                    </div>
                    <div class="my-3">
                        ...
                        <input type="hidden" name="category" id="kategori_list_input" value="{{ $data->category }}">
                    </div>
                    <div class="mb-3">
                        <label for="deskripsi_input" class="form-label font-15 fw-bold">Deskripsi</label>
                        <textarea class="form-control font-14" id="deskripsi_input" rows="3" name="description">{{ $data->description }}</textarea>
                    </div>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input sold-art" type="checkbox" id="flexSwitchCheckChecked"
                                    ...
                                    checked
                                    @endif >
                                <input type="hidden" name="is_sell" id="is_sell" value="{{ $data->is_sell == 1 ? 'true' : 'false'}}">
                            </div>
                    ...
                    <div class="my-3" id="pembayaran">
                        <div class="my-3">
                            ...
                            <div class="d-flex align-items-center col-md-3">
                                ...
                                <input type="text" class="form-control font-14" id="input_judul" placeholder="" name="price" value="{{ $data->price }}">
                            </div>
                        </div>
                    ...
                    <button class="button-tambah-karya my-3" type="submit">Save</button>
                </div>
            </div>
        </form>
...
@section('script')
    <script src="{{ asset('js/edit-karya.js') }}"></script>
@endsection
