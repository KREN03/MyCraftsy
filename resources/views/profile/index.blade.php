                            ...
                            <div class="col-md-3 p-1 grid-item">
                                <div class="position-relative">
                                    ...
                                    <div class="position-absolute banner-item-button">
                                        <div class="dropdown-option p-2 rounded-circle button-banner-menu" id="button-banner-menu">
                                            ...
                                            <div class="menu position-absolute rounded modal-menu" id="">
                                                <a href="{{ route('view_edit_karya', $item->id) }}" class="font-14 d-flex align-items-center">
                                                ...
                                                <a href="" class="font-14 d-flex align-items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-trash-fill me-2" viewBox="0 0 16 16">
